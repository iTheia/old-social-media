...
export default function Post(props) {
    if(props.loading){
        return ( 
            <article className="post blank" style={{height:'400px'}}>
    ...
    return (
        <article className="post">
            <header>
                <Link to={`/profiles/${props.post.author._id}`} className="post__author-info">
            ...
            <div className="post__media">
                <img className="post-image" src={require('./test.jpg')} alt=""/>
            </div>
            <div className="post__footer">
                <div className="post__footer-info">
                    <div className="actions">
                        ...
                        <Link className="action" to={`/posts/${props.post._id}`}>
