...
export default function Post(props) {
	...
	const [liked, setLiked] = useState(() => {
		...
		console.log(post.likes.find((like) => like === user_id));
		return post.likes.find((like) => like === user_id);
	});
	...
	const Header = () => (
		<header>
			...
			<button onClick={() => console.log(post)}>asd</button>
	...
	const Footer = () => (
		<div className="post__footer">
			<div className="post__footer-info">
				...
				<button className="likes">{likes} Likes</button>
			</div>
