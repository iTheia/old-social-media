...
const Comments = (props) => {
    ...
    const deleteComment = deleted_id => setComments(comments => comments.filter(comment => comment._id !==  deleted_id ))
    const printComments = () => comments.map((comment) => <Comment deleteC={deleteComment} post_id={post_id} comment={comment} key={comment._id}/>)
