...
const Post = (props) =>(
    <div className="profile-posts-container">
        {props.post.map(post => (
            <button key={post._id} className="post-profile">
                <img className="image" src={require('../components/test.jpg')} alt=""/>
                <div className="data">
                    <div className="stat">
                    ...
                    <div className="stat">
                        <svg aria-label="Comentar" fill="#ffffff" height="24" viewBox="0 0 48 48" width="24">
